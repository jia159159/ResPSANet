...
class ResPSANet(nn.Module):
    def __init__(self,block, layers, num_classes=3):
        super(ResPSANet, self).__init__()
        self.inplanes = 64
...
def res_psa_net():
    model = ResPSANet(ResPSA, [1, 1, 1], num_classes=3)
    return model
...
if __name__ == '__main__':
    ...
    print(epsanet)
# def epsanet50():
#     model = EPSANet(EPSABlock, [3, 4, 6, 3], num_classes=3)
#     return model

# def epsanet101():
#     model = EPSANet(EPSABlock, [3, 4, 23, 3], num_classes=3)
#     return model
